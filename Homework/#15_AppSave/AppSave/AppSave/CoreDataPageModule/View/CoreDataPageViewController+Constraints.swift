//
//  CoreDataPageViewController+Constraints.swift
//  AppSave
//
...
import Foundation
extension CoreDataPageViewController {
    func addViewConstraints() {
        self.emptyCoreDataView.translatesAutoresizingMaskIntoConstraints = false
        self.emptyCoreDataView.topAnchor.constraint(equalTo: self.searchBar.bottomAnchor, constant: 20).isActive = true
